...
This document defines the first playable product slice of OpenVayra - Cities in practical, implementation-facing terms.
...
OpenVayra - Cities is a desktop-only, browser-based transit network simulation game in which the player designs and operates a custom public transport network inside a believable urban environment.
...
This is mandatory because OpenVayra - Cities is expected to interact with coding agents, and undocumented exports create drift, misuse, and duplication.
...
OpenVayra - Cities must not rely on loosely typed domain truth, duplicated ad-hoc unions, or scattered informal constants.
...
The first phase of OpenVayra - Cities must not drift into any of the following:
